  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          width: isCollapsed ? "64px" : window.innerWidth < 768 ? "280px" : "320px",
          position: window.innerWidth < 768 ? "fixed" : "fixed",
          top: 0,
          left: isMobileOpen || window.innerWidth >= 768 ? 0 : isCollapsed ? "-64px" : "-320px",
          height: "100vh",
          zIndex: 1045,
      ...
      >
        {/* Header */}
        <div
          className="border-bottom d-flex flex-column gap-3"
          style={{ 
        ...
        >
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex gap-2">
              {/* Mobile Close Button */}
              <button
                className="btn p-1 d-flex d-md-none align-items-center justify-content-center"
                onClick={onMobileClose}
                style={{
              ...
              <button
                className="btn p-1 d-none d-md-flex align-items-center justify-content-center"
            ...
            <div className="p-2">
              {sessions.map((session) => (
                <div
                  ...
                  className={`rounded-3 mb-2 cursor-pointer position-relative ${
            ...
            {!isCollapsed && (
              <>
                <div className="flex-grow-1 min-width-0">
                  ...
                  <div style={{ fontSize: "10px", color: "#8b949e" }}>Online</div>
                </div>

                {/* Settings (three-dots) - Hidden on mobile for space */}
                <button
                  className="btn btn-sm d-none d-lg-flex align-items-center justify-content-center p-1"
                  style={{
                    backgroundColor: "transparent",
                    border: "1px solid #30363d",
                    color: "#8b949e",
